...
- `ciclo_core.qnt`: finite model of Beads work ownership, Beads remote DB health, multi-user authorization, command approval, and remote session loss.
...
Update the model whenever implementation changes affect Beads claims, authorization, command approval, remote session ownership, or token handling.
