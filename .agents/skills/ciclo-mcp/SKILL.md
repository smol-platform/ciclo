...
- Use `examples/ciclo-config.json` in the Ciclo repository as the reference shape for provider aliases, MCP secret bindings, prompt guidance, remote runner defaults, WireGuard settings, and provider-specific runner blocks.
